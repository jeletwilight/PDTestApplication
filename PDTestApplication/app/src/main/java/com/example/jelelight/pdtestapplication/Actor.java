...
public class Actor {
    ...
    public Actor(Actor actor){
        ...
        this.setLogin(actor.getLogin());
        this.setDisplay_login(actor.getDisplay_login());
        this.setGravatar_id(actor.getGravatar_id());
        this.setAvatar_url(actor.getAvatar_url());
        this.setUrl(actor.getUrl());
    }
